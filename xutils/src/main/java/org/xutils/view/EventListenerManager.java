...
/*package*/ final class EventListenerManager {
    ...
    private final static HashSet<String> AVOID_QUICK_EVENT_SET = new HashSet<String>(4);

    static {
        AVOID_QUICK_EVENT_SET.add("onClick");
        AVOID_QUICK_EVENT_SET.add("onItemClick");
        AVOID_QUICK_EVENT_SET.add("OnCheckedChange");
        AVOID_QUICK_EVENT_SET.add("OnPageChange");
    }
